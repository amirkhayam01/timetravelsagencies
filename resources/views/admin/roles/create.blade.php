                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group bmd-form-group">
                                        <input class="form-control" name="name" id="input-name" type="text" placeholder="Role Name" value="" required="true" aria-required="true">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group bmd-form-group">
                                        <textarea cols="30" rows="10" class="form-control" name="description" id="input-description" type="text" placeholder="Description" required="true" aria-required="true"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
